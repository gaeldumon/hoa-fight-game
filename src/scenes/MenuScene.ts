...
export class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.image(
            this.mapPicker.window.x,
            this.mapPicker.window.y,
            "windowBlank"
        ).setScale(0.70, 0.70);

        // Map thumbnail
        this.levelThumb = this.add.image(
            this.mapPicker.thumbnail.x,
            this.mapPicker.thumbnail.y,
            this.data.get("levels").at(0).thumbnailKey
        ).setScale(0.70, 0.70);
        ...
        // Next map button
        const nexMapButton = this.add.image(
            this.mapPicker.button.x,
            this.mapPicker.button.y,
            "tabWood"
        ).setInteractive({
            cursor: "pointer"
        }).on("pointerover", () => {
        ...
        this.add.image(
            this.characterPickerUser1.window.x,
            this.characterPickerUser1.window.y,
            "windowBlank"
        ).setScale(0.70, 0.70);

        // Character of player 1 thumbnail
        const charThumbPlayer1 = this.add.image(
            this.characterPickerUser1.thumbnail.x,
            this.characterPickerUser1.thumbnail.y,
            this.data.get("characters").at(0).thumbnailKey
        ).setScale(0.80, 0.80);
        ...
        const nextCharPlayer1 = this.add.image(
            this.characterPickerUser1.button.x,
            this.characterPickerUser1.button.y,
            "tabWood"
        ).setInteractive({
            cursor: "pointer"
        }).on("pointerover", () => {
        ...
        this.add.image(
            this.characterPickerUser2.window.x,
            this.characterPickerUser2.window.y,
            "windowBlank"
        ).setScale(0.70, 0.70);

        // Character of player 2 thumbnail
        const charThumbPlayer2 = this.add.image(
            this.characterPickerUser2.thumbnail.x,
            this.characterPickerUser2.thumbnail.y,
            this.data.get("characters").at(0).thumbnailKey
        ).setScale(0.80, 0.80);
        ...
        // Next character button for player 1
        const nextCharPlayer2 = this.add.image(
            this.characterPickerUser2.button.x,
            this.characterPickerUser2.button.y,
            "tabWood"
        ).setInteractive({
            cursor: "pointer"
        }).on("pointerover", () => {
        ...
        const nextSceneButton = this.add.image(
            gameWidth(this) / 2,
            gameHeight(this) - 100,
            "textButtonWood"
        ).setInteractive({
